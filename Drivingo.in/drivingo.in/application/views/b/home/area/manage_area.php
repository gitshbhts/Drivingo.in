<div class="page-content-wrapper">
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Manage Area</div>
                            </div>
		...
		<button class="btn btn-danger btn-xs"><a href="<?php echo base_url();?>index.php/backend/delete_area/<?php echo $data['area_id'];?>"  style="color:white;" >
