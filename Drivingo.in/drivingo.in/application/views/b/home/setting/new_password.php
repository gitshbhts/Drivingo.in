  ...
  <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="row">
                        ...
                        <form class="form-horizontal" action="<?php echo base_url();?>index.php/backend/confirm_update_admin" id="submit_form" method="POST">
                          ...
                          <h3 class="block">Add New Passord</h3>
