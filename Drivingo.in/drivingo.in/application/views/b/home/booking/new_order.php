                ...
                <div class="page-content">
                    <div class="page-bar">
                        ...
                        <div class="col-md-12 col-sm-12">
                           ...
                           <form action="<?php echo base_url();?>index.php/backend/add_histroy" method="post" >
                                          <div class="form-group">
                                        <div class="fg-line">
                                           <button class="btn btn-primary btn-sm">Add to history</button>
                                        </div>
                                    </div>
                                <div class="card-body ">
                                  <div class="table-wrap">
					                   ...
					                   <tbody>
										...
										<input type="checkbox" name="id[]" value="<?php echo $data['id'];?>">
													...
													<?php echo 												$data['delivery_area'];?>
															<?php echo 										$data['delivery_city'];?><br>
															<?php echo 										$data['contact'];?></td>
																	<td><?php echo $data['school_name'];?></td>
																	<td><?php echo $data['area'];?>
