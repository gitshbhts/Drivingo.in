                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Manage Discount</div>
                            </div>
											   ...
											   <?php foreach($category as $data){?>
					                                        <tbody>
																...
																<?php echo $data['id'];?>
																	...
																	<td><?php echo $data['discount_code'];?></td>
																	<td><?php echo $data['percentage'];?></td>
																	
																	<td>
																		<button class="btn btn-primary btn-xs">
																			<a href="<?php echo base_url();?>index.php/backend/delete_discount_code/<?php echo $data['id'];?>"  style="color:white;"  ><i class="fa fa-trash-o"></i><a>
																		</button>
